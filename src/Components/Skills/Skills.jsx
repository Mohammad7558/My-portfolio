...
const AdditionalHighlights = () => (
  <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-6 mt-12">
    {[
      {
        title: "Clean Code",
        desc: "Readable, maintainable code with best practices.",
      },
      {
        title: "Responsive Design",
        desc: "Great UX on all devices with mobile-first approach.",
      },
      {
        title: "Performance Optimization",
        desc: "Fast load times & smooth user experience.",
      },
      {
      ...
      },
      {
        ...
        desc: "Seamless connection between frontend & backend.",
      },
      {
        title: "Team Collaboration",
        desc: "Efficient with Git & GitHub for teamwork.",
      },
    ].map((item, idx) => (
      <div
        key={idx}
      ...
      >
        <h4 className="font-semibold text-cyan-600 mb-2 text-lg">{item.title}</h4>
  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto relative z-10">
        ...
        <h3 className="text-2xl font-semibold text-gray-800 mt-16 mb-0 border-b border-cyan-600 inline-block pb-1">
