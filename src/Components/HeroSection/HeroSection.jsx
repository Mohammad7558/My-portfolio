...
const HeroSection = () => {
  ...
  return (
    <section id="home"
      ...
      style={{
        background:
          "linear-gradient(45deg, rgba(147, 197, 253, 0.2), rgba(196, 181, 253, 0.2)), repeating-linear-gradient(0deg, rgba(224, 231, 255, 0.4) 0, rgba(224, 231, 255, 0.4) 1px, transparent 1px, transparent 20px), repeating-linear-gradient(90deg, rgba(224, 231, 255, 0.4) 0, rgba(224, 231, 255, 0.4) 1px, transparent 1px, transparent 20px)",
      }}
    >
      {/* 🔵 Background Blobs */}
        ...
        <div className="relative z-20 flex flex-col-reverse md:flex-row items-center gap-8 md:gap-12 justify-between">
          ...
          <div className="max-w-xl text-center md:text-left space-y-6">
            ...
            <div className="flex justify-center md:justify-start space-x-6 text-3xl text-cyan-600">
              <a
                href="https://github.com/Mohammad7558/" target="_blank"
                className="hover:text-cyan-800 transition-colors duration-300"
              >
                <FaGithub />
              </a>
              <a
                href="https://www.linkedin.com/in/mohammod-bin-amin-b051a0244/" target="_blank"
                className="hover:text-cyan-800 transition-colors duration-300"
              >
                <FaLinkedin />
              </a>
              <a
                href="https://x.com/iam_MOHAMMOD" target="_blank"
                className="hover:text-cyan-800 transition-colors duration-300"
              >
                <FaTwitter />
              </a>
